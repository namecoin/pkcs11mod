...
testdata/try-firefox-connect.bash www.namecoin.org success "" || testdata/dump-proxy-log-fail.bash
testdata/assert-proxy-log.bash missing

testdata/try-firefox-connect.bash untrusted-root.badssl.com fail "Certificate error was not overridden" || testdata/dump-proxy-log-fail.bash
testdata/assert-proxy-log.bash missing
...
testdata/try-firefox-connect.bash www.namecoin.org fail "Certificate error was not overridden" || testdata/dump-proxy-log-fail.bash
testdata/assert-proxy-log.bash missing
