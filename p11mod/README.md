...
Set the environment variable `P11MOD_TRACE=1` to enable debug tracing.  The trace will be outputted to the log file. Also see the [pkcs11mod tracing](../#tracing) documentation.
